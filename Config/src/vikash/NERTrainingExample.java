...
public class NERTrainingExample {
	...
	public static void main(String[] args) {
		...
		try {
			in = new MarkableFileInputStreamFactory(new File("C:/models/Training_file/AnnotatedSentences1.txt"));
		...
		try {
			File output = new File("C:/models/trained_models/en-ner-person2.bin");
	   ...
	   // String[] testSentence ={"Vikash","Kumar","is","a","tourist","from","Spain"};
	     String sentence ="Vikash Jumar is  a tourist from spain";
